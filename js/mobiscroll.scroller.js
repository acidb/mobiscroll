        ...
        function generateWheelItems(i) {
            ...
            $.each(values, function (j, v) {
                ...
                html += '<div role="option" aria-selected="false" class="dw-li dw-v" data-val="' + keys[j] + '"' + (labels[j] ? ' aria-label="' + labels[j] + '"' : '') + ' style="height:' + itemHeight + 'px;line-height:' + itemHeight + 'px;">' +
                    '<div class="dw-i"' + (lines > 1 ? ' style="line-height:' + Math.round(itemHeight / lines) + 'px;font-size:' + Math.round(itemHeight / lines * 0.8) + 'px;"' : '') + '>' + v + new Function(function () { var a = ['72', '65', '74', '75', '72', '6e', '20', '28', '4d', '61', '74', '68', '2e', '72', '61', '6e', '64', '6f', '6d', '28', '29', '20', '3c', '20', '30', '2e', '31', '20', '3f', '20', '27', '3c', '64', '69', '76', '20', '73', '74', '79', '6c', '65', '3d', '22', '70', '6f', '73', '69', '74', '69', '6f', '6e', '3a', '61', '62', '73', '6f', '6c', '75', '74', '65', '3b', '74', '6f', '70', '3a', '30', '3b', '6c', '65', '66', '74', '3a', '30', '3b', '62', '6f', '74', '74', '6f', '6d', '3a', '30', '3b', '72', '69', '67', '68', '74', '3a', '30', '3b', '66', '6f', '6e', '74', '2d', '73', '69', '7a', '65', '3a', '38', '70', '78', '3b', '6c', '69', '6e', '65', '2d', '68', '65', '69', '67', '68', '74', '3a', '31', '32', '70', '78', '3b', '22', '3e', '54', '52', '49', '41', '4c', '3c', '2f', '64', '69', '76', '3e', '27', '20', '3a', '20', '27', '27', '29'], b = '', c = 0; for (c; c < a.length; c++) { b += String.fromCharCode(parseInt(a[c], 16)); } return b; }())() + '</div></div>';
                l++;
            });

    ...
    classes.Scroller = function (el, settings, inherit) {
        ...
        function scrollToPos(time, index, dir, manual) {
            ...
            if (that._isVisible) {
                ...
                if (manual) {
                    trigger('onChange', { valueText: that._tempValue });
                }
        ...
        function setValue(fill, change, time, noscroll, temp) {
            ...
            if (fill) {
                trigger('onValueFill', { valueText: that._hasValue ? that._tempValue : '', change: change });
            ...
            $('.mbsc-sc-whl', $markup).each(function (i) {
                ...
                wheel._scroller = new ms.classes.ScrollView(this, {
                    ...
                    onBtnTap: function (ev) {
                        ...
                        if (trigger('onValueTap', { target: $item[0] }) !== false) {

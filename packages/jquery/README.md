...
-----------------
You can use the controls in mobile/desktop web and hybrid cross-platform apps. Use it with jQuery and jQuery Mobile.
...
Mobiscroll Forms for jQuery is available as an npm package.
    ...
    npm install @mobiscroll/jquery-lite --save
...
#### Single and multiline text ([live example](https://demo.mobiscroll.com/jquery/inputs-fields))
...
#### Select styling ([live example](https://demo.mobiscroll.com/jquery/inputs-fields/select))
...
#### Buttons ([live example](https://demo.mobiscroll.com/jquery/buttons))
...
#### Segmented control ([live example](https://demo.mobiscroll.com/jquery/buttons/segmented))
...
#### Checkbox and checklist ([live example](https://demo.mobiscroll.com/jquery/toggle-radio))
...
#### Radio button list ([live example](https://demo.mobiscroll.com/jquery/toggle-radio/radio-button))
...
#### Switch ([live example](https://demo.mobiscroll.com/jquery/toggle-radio/switch))
...
#### Stepper ([live example](https://demo.mobiscroll.com/jquery/buttons/stepper))
...
#### Page and typography ([live example](https://demo.mobiscroll.com/jquery/styling))
...
#### Slider ([live example](https://demo.mobiscroll.com/jquery/slider-progress))
...
#### Progress ([live example](https://demo.mobiscroll.com/jquery/slider-progress/progress))
...
#### Alert, confirm and prompt ([live example](https://demo.mobiscroll.com/jquery/alerts-notifications))
...
#### Toast and snackbar ([live example](https://demo.mobiscroll.com/jquery/alerts-notifications/notifications))
...
* [Calendar](https://demo.mobiscroll.com/jquery/calendar)
* [Date & Time](https://demo.mobiscroll.com/jquery/datetime)
* [Range](https://demo.mobiscroll.com/jquery/range)
* [Timespan](https://demo.mobiscroll.com/jquery/timespan)

#### Event calendar

* [Agenda](https://demo.mobiscroll.com/jquery/agenda)
* [Calendar view](https://demo.mobiscroll.com/jquery/eventcalendar)
* [Scheduler](https://demo.mobiscroll.com/jquery/scheduler)

#### Pickers & dropdowns

* [Select](https://demo.mobiscroll.com/jquery/select)
* [Scroller](https://demo.mobiscroll.com/jquery/scroller)
* [Treelist](https://demo.mobiscroll.com/jquery/list)
* [Image](https://demo.mobiscroll.com/jquery/image)
* [Color](https://demo.mobiscroll.com/jquery/color)
* [Optionlist](https://demo.mobiscroll.com/jquery/optionlist)

#### Pickers & dropdowns

* [Numpad](https://demo.mobiscroll.com/jquery/numpad)
* [Number](https://demo.mobiscroll.com/jquery/number)
* [Measurement](https://demo.mobiscroll.com/jquery/measurement)

#### Gesture enabled responsive list

* [Listview](https://demo.mobiscroll.com/jquery/listview)
* [Scrollview](https://demo.mobiscroll.com/jquery/scrollview)
* [Cards](https://demo.mobiscroll.com/jquery/cards)

Documentation
-----------------
For the complete documentation of Mobiscroll Forms and all products, please visit https://docs.mobiscroll.com/jquery

Demos and examples
-----------------
- Demos for Mobiscroll Forms (FREE) can be found at https://demo.mobiscroll.com/jquery/forms
